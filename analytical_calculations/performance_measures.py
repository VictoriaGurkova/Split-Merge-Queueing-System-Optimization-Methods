...
class PerformanceMeasuresStorage:
    ...
    def append(
        self, policy_vector: tuple, performance_measures: PerformanceMeasures
    ) -> None:
        ...
        self.blocked_all_queues_probability.append(
            performance_measures.blocked_all_queues_probability
        )
        ...
        self.avgs_demands_on_servers1.append(
            performance_measures.avg_demands_on_servers1
        )
        self.avgs_demands_on_servers2.append(
            performance_measures.avg_demands_on_servers2
        )
        self.avgs_free_servers.append(performance_measures.avg_free_servers)
        self.avgs_free_servers_if_queues_not_empty.append(
            performance_measures.avg_free_servers_if_queues_not_empty
        )
    ...
    def show_difference(self) -> None:
        ...
        self.__print_difference_details(
            "blocked_prob", self.blocked_all_queues_probability
        )
        ...
        self.__print_difference_details(
            "avg_ds_on_serv1", self.avgs_demands_on_servers1
        )
        self.__print_difference_details(
            "avg_ds_on_serv2", self.avgs_demands_on_servers2
        )
        self.__print_difference_details("avg_free_serv", self.avgs_free_servers)
        self.__print_difference_details(
            "avg_free_serv_if_q_not_empty", self.avgs_free_servers_if_queues_not_empty
        )
