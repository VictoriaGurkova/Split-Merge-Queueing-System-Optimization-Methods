...
def example1(lambdas, queue_id):
    ...
    plt.grid()
    plt.plot(
        lambdas, storage.response_times1, "g", label="T1", linewidth=2, markersize=12
    )
    plt.plot(
        lambdas, storage.response_times2, "b", label="T2", linewidth=2, markersize=12
    )
    plt.legend()
    plt.show()
    ...
    plt.grid()
    plt.plot(
        lambdas, storage.blocked_all_queues_probability, "b", linewidth=2, markersize=12
    )
    plt.show()
